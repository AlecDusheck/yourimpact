...
export const WORKS_CITED: WorksCited[] = [
  ...
  {
    sourceType: SourceType.IMAGE,
    link: 'https://im-media.voltron.voanews.com/Drupal/01live-166/styles/sourced/s3/2019-04/197E591D-5B79-48A7-8018-E1B13E3E4B2A.jpg?itok=YxDbxiWF',
    publication: 'Reuters',
    author: 'Al-Assaad, Fadi',
    title: 'Image of the Quran',
    dateAccessed: '4 Dec. 2020',
    annotation: 'Image of the Quran',
  },
  {
    sourceType: SourceType.ACADEMIC,
    link: 'https://www.britannica.com/topic/Quran',
    publication: 'Britannica',
    author: 'Ringgren, Helmer',
    dateAccessed: '4 Dec. 2020',
    title: 'Qurʾān\n Introduction',
    annotation: 'A introduction to the Quran'
  },
  {
    sourceType: SourceType.ACADEMIC,
    link: 'https://theconversation.com/caliphate-a-disputed-concept-no-longer-has-a-hold-over-all-muslims-41521',
    title: 'Caliphate, a disputed concept, no longer has a hold over all Muslims',
    dateAccessed: '4 Dec. 2020',
    author: 'Dogan, Recep',
    date: '2 Jul. 2015',
    publication: 'The Conversation',
    annotation: 'A article on Islamic Caliphates',
  },
  {
    sourceType: SourceType.ACADEMIC,
    link: 'https://books.google.com/books?id=zvmKBAAAQBAJ&printsec=frontcover&source=gbs_ge_summary_r&cad=0#v=onepage&q&f=false',
    publication: 'Oxford University Press',
    date: '2006',
  ...
  {
    sourceType: SourceType.ACADEMIC,
    link: 'https://depts.washington.edu/silkroad/exhibit/religion/islam/essay.html',
    author: 'Szostak, John',
    title: 'The Spread of Islam Along the Silk Route',
  ...
  {
    sourceType: SourceType.BACKGROUND,
    link: 'https://ccnmtl.columbia.edu/services/dropoff/china_civ_temp/week06/pdfs/religi.pdf',
    title: 'Religion and Overland Trade in Asia, 1000 BC to AD 1400',
    annotation: '',
    dateAccessed: '4 Dec. 2020',
